          ...
          <div class="row">
            <div class="col-xl-3 col-md-6">
              <div class="card bg-primary text-white mb-4">
                <div class="card-body">Input Data Dokter</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                  <a class="small text-white stretched-link" href="input_dokter.php">input</a>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card bg-warning text-white mb-4">
                <div class="card-body">Input Data Klinik</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                  <a class="small text-white stretched-link" href="input_klinik.php">Input</a>
                  <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-md-6">
              <div class="card bg-success text-white mb-4">
                <div class="card-body">Lihat Data Dokter</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                  <a class="small text-white stretched-link" href="data_dokter.php">View Data</a>
                  <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-md-6">
              <div class="card bg-danger text-white mb-4">
                <div class="card-body">Lihat Data Klinik</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                  <a class="small text-white stretched-link" href="data_klinik.php">View Data</a>
                  <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  ...
                  $sql = "SELECT dokter.nip_dokter, dokter.nama, dokter.alamat, dokter.jam_mulai, dokter.jam_selesai, dokter.id_klinik, dokter.no_hp, klinik.nama_klinik
                                            FROM dokter
                  ...
                  ?>
                    <tr>
                      <td><?= $data_dokter['nip_dokter'] ?></td>
                      <td><?= $data_dokter['nama'] ?></td>
                      <td><?= $data_dokter['alamat'] ?></td>
                      <td><?= $data_dokter['jam_mulai'] ?></td>
                      <td><?= $data_dokter['jam_selesai'] ?></td>
