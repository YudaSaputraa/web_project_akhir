            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Data_Dokter</li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a type="submit" href="edit_dokter.php?nip_dokter=<?= $data_dokter['nip_dokter'] ?>" class="btn"><img src="../assets/user.png" width="25px" alt=""></a></td>
                                            <td> <a type="submit" href="../operation/delete.php?nip_dokter=<?= $data_dokter['nip_dokter'] ?>" class="btn"><img src="../assets/delete.png" width="25px" alt=""></a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
