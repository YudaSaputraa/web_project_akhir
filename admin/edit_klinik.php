                ...
                <div class="main">
                    <div class="mt-3 w-100 container">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Input_Klinik</li>
                        ...
                        <div class="row container-fluid px4">
                            ...
                            <div class=" form-input col-6">
                                <form method="POST" action="../operation/edit_klinik_process.php">
                                    <center class="mt-4">
                                        <img src="../assets/checklist.png" width="50px" alt="">
                                        <a style="font-family: 'Poppins'; font-size:35px; color:white; font-weight:500;">Data Klinik
                                            <hr size="2px" width="100%" color="white" />
                                        </a>

                                        <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Tambah Data Klinik</h5>
                                        <?php
                                        include '../connection/connection.php';
                                        $id_klinik =  $_GET['id_klinik'];
                                        $sql = "SELECT * FROM klinik WHERE id_klinik = '$id_klinik'";
                                        $query = mysqli_query($connect, $sql);
                                        $data_klinik = mysqli_fetch_array($query);
                                        ?>
                                        <input type="hidden" name="id_klinik" value="<?= $data_klinik['id_klinik'] ?>">
                                        <div class="main-right row p-4">
                                            <br>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Klinik" value="<?= $data_klinik['nama_klinik'] ?>" name="nama_klinik">
                                            </div>

                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Lokasi/Ruangan Klinik" value="<?= $data_klinik['alamat_klinik'] ?>" name="alamat_klinik">

                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Deskripsi" value="<?= $data_klinik['deskripsi_klinik'] ?>" name="deskripsi">
                                            </div>
                                            <div class="col mt-4">
