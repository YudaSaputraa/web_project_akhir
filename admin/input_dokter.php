                ...
                <div class="main">
                    <div class="mt-3 w-100 container">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Input_Dokter</li>
                        ...
                        <div class="row container-fluid px4">
                            ...
                            <div class=" form-input col-7">
                                <form method="POST" action="../operation/input_dokter_process.php">
                                    <center class="mt-4">
                                        ...
                                        <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Masukkan Biodata Dokter</h5>
                                        <div class="main-right row p-4">
                                            <br>
                                            <div class="col">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Dokter" name="nama_dokter">
                                            </div>
                                            <div class="col">
                                                <input type="text" class="form-control bg-transparent  text-white font-weight-normal" placeholder="NIP Dokter" name="nip_dokter">
                                            </div>
                                            <div class="col mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="No.Hp Dokter" name="nohp_dokter">
                                            </div>
                                            <br>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Alamat Dokter" name="alamat_dokter">
                                            ...
                                            <div class=" col">
                                                ...
                                                <input type="time" class="form-control bg-transparent text-white font-weight-normal mt-3 mb-3" name="jam_mulai" required="">

                                            </div>
                                            <div class=" col">
                                                <p class="text-white" style="font-size : 15px; margin-bottom: -13px;">Jam Selesai</p>
                                                <input type="time" class="form-control bg-transparent text-white font-weight-normal mt-3 mb-3" name="jam_selesai" required="">
